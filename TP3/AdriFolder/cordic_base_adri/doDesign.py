...
def scriptMain ( **kw ):
    ...
    try:
        ...
        cell = af.getCell( 'cordic_cor', CRL.Catalog.State.Logical )
        if not cell:
            cell = CRL.Blif.load( 'cordic_cor' )
        if editor:
            editor.setCell( cell ) 
        ...
        ioPadsSpec = [ (IoPin.WEST , None, 'ck'       , 'ck'  , 'ck'  )
                    ...
                    , (IoPin.WEST , None, 'p_a_p_0'       , 'a_p(0)'  , 'a_p[0]'  )
                    , (IoPin.WEST , None, 'p_a_p_1'       , 'a_p(1)'  , 'a_p[1]'  )
                    , (IoPin.WEST , None, 'p_a_p_2'       , 'a_p(2)'  , 'a_p[2]'  )
                    ...
                    , (IoPin.SOUTH , None, 'p_x_p_3'       , 'x_p(3)'  , 'x_p[3]'  )
                    , (IoPin.SOUTH , None, 'p_x_p_4'       , 'x_p(4)'  , 'x_p[4]'  )
                    , (IoPin.SOUTH , None, 'p_x_p_5'       , 'x_p(5)'  , 'x_p[5]'  )
                    ...
                    , (IoPin.EAST , None, 'p_y_p_2'       , 'y_p(2)'  , 'y_p[2]'  )
                    , (IoPin.EAST , None, 'p_y_p_3'       , 'y_p(3)'  , 'y_p[3]'  )
...
#                     ]
        pinSpacing = 10
        ioPinsSpec = [  (IoPin.WEST |IoPin.A_BEGIN, 'a_p({})'  ,    pinSpacing, 2*pinSpacing,  8)
                      , (IoPin.SOUTH |IoPin.A_BEGIN, 'x_p({})'  , pinSpacing, 2*pinSpacing,  8)
                      , (IoPin.EAST |IoPin.A_BEGIN, 'nx_p({})'  , pinSpacing, 2*pinSpacing,  8)
                      , (IoPin.EAST |IoPin.A_BEGIN, 'y_p({})'  , 9*2*pinSpacing, 2*pinSpacing,  (0,1,2,3))
...
#                      , (IoPin.NORTH|IoPin.A_BEGIN, 'reset'   , 15*pinSpacing,          0 , 1)
       ...
       #conf.cfg.anabatic.searchHalo         = 2
        ...
        conf.cfg.katana.hTracksReservedMin   = 16
        #conf.cfg.katana.vTracksReservedMin   = 6
        conf.cfg.katana.vTracksReservedMin   = 17
