...
ruleVasy  = Vasy.mkRule( 'vasy_init', 'cordic_cor.v', "cordic_cor.vhd", flags=Vasy.UseStdLogic|Vasy.AddPowerSupplies )
ruleYosys = Yosys   .mkRule( 'yosys', 'cordic_cor.v' )
ruleB2V   = Blif2Vst.mkRule( 'b2v'  , 'cordic_cor.vst', [ruleYosys], flags=0 )
...
if buildChip:
    ...
    rulePnR = PnR.mkRule( 'gds'    , [ 'cordic_cor_cts_r.gds'
                                     , 'cordic_cor_cts_r.vst'
                                     , 'cordic_cor_cts_r.spi'
                                     ]
                                     , [ruleB2V]
                                   , scriptMain
                                   , topName=topName )
    PnR.CheckLvs = False
#    ruleX2Y = x2y.mkRule( 'spi2vst', 'cordic_cor_cts_r_spi.vst', 'cordic_cor_cts_r.spi' )
#    ruleLvx = Lvx.mkRule( 'lvx_spi', [ 'cordic_cor_cts_r.vst', 'cordic_cor_cts_r.spi' ]
#                                   , Lvx.MergeSupply|Lvx.Flatten )
    staLayout = rulePnR.file_target( 2 )
#    vlogSim   = rulePnR.file_target( 1 )
#    ruleVasy  = Vasy.mkRule( 'vasy', 'cordic_cor_cts_r.v', vlogSim, Vasy.Overwrite|Vasy.RemovePowerSupplies )
