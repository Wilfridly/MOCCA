entity one_in_three_out_for_cordic is
port(
    ck       : in  std_logic;
    raz      : in  std_logic;
...
end one_in_three_out_for_cordic;

architecture vhd of one_in_three_out_for_cordic is
...
-- FSM combinatoire
-------------------------------------------------
process(state, wr_arg_p, counter)
begin
    -- valeurs par défaut
    n_state   <= state;
    n_counter <= counter;
...
wok_arg_p <= '1' when state = '1 else '0'; --handshake
