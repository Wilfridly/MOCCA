...
add search path -library /users/soft/techno/dev/grenoble/hcmos9gp_920/CORE9GPHS_SNPS_AVT_4.1.a/SNPS/bc_1.32V_0C_wc_1.08V_125C/PHS/
...
read design -rangeconstraint -configuration  -enumconstraint -golden -lastmod -noelab \
	-vhdl 93 \
		/users/enseig/lyautey/M2_SESI/MOCCA/PART2/TP2_3/mips_32_1p_mul_div_async.vhd
