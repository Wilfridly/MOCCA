...
ARCHITECTURE vhd OF cordic_cor IS
    ...
    SIGNAL
        n_get_a,  get_a,            -- get coordinates and angle
        n_get_x,  get_x,
        n_get_y,  get_y,
...
-------------------------------------------------------------------------------
    ...
    n_get_a     <= (get_a  AND NOT wr_axy_p)
                OR (put_y  AND rd_nxy_p)
                ;
    n_get_x     <= (get_x  AND NOT wr_axy_p)
                OR (get_a  AND wr_axy_p)
                ;
    n_get_y     <= (get_y  AND NOT wr_axy_p)
                OR (get_x  AND wr_axy_p)
    		;
    n_norm      <= (get_y  AND wr_axy_p)
    ...
    n_place     <= (mkc  AND (i = 2))
                ;
    n_put_x     <= (place)
                OR (put_x  AND NOT rd_nxy_p)
                ;
    n_put_y	<= (put_x AND rd_nxy_p)
    		OR (put_y AND NOT rd_nxy_p)
    		; 
...
-------------------------------------------------------------------------------
    ...
    n_quadrant  <= "00"           when get_a or get_x or get_y
    ...
    n_i         <= "000"      when get_a or get_x or get_y -- init
...
-------------------------------------------------------------------------------
    ...
    n_x         <= axy_p(7) & axy_p & "0000000" when get_x                -- init
    ...
    n_y         <= axy_p(7) & axy_p & "0000000" when get_y                -- init
    ...
    nxy_p        <=  x(14 downto 7) when put_x 
    		else y(14 downto 7);
